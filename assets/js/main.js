...
const traumatologia = [
    ...
    { hora: '10:00', especialista: 'RAUL ARAYA', paciente: 'CARMEN ISLA', rut: '10112348-3', prevision: 'ISAPRE' },
...
mostrarNombres(radiologia);
mostrarNombres(traumatologia);
mostrarNombres(dental);
